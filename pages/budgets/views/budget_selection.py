...
class BudgetSelection(ttb.Toplevel):
    def __init__(self, master=None, callback=None, selectionMode = False, filter_status = None):
        ...
        ttb.Label(subtitle, text='Busqueda de Cotizaciones', background=PART2_COLOR, anchor='sw', font=(GUI_FONT,13,'bold'), foreground='#fff').grid(row=0, column=1, sticky='nsew', padx=(4,8), pady=(8,0))

        ttb.Label(subtitle, text='Inicio / Cotizaciones / Busqueda', background=PART2_COLOR, anchor='nw', font=(GUI_FONT,9), foreground='#fff').grid(row=1, column=1, sticky='nsew', padx=(4,8), pady=(0,8))
        ...
        self.budgetsGridView.column(columns[0],width=160,stretch=True,anchor='center')
        self.budgetsGridView.column(columns[1],width=300,stretch=True,anchor='center')
        self.budgetsGridView.column(columns[2],width=200,stretch=True,anchor='center')
        self.budgetsGridView.column(columns[3],width=200,stretch=True,anchor='center')
        self.budgetsGridView.column(columns[4],width=300,stretch=True,anchor='center')
        self.budgetsGridView.column(columns[5],width=200,stretch=True,anchor='center')
        self.budgetsGridView.column(columns[6],width=200,stretch=True,anchor='center')
        self.budgetsGridView.column(columns[7],width=200,stretch=True,anchor='center')
        self.budgetsGridView.column(columns[8],width=200,stretch=True,anchor='center')
        self.budgetsGridView.column(columns[9],width=200,stretch=True,anchor='center')
        self.budgetsGridView.column(columns[10],width=200,stretch=True,anchor='center')
        self.budgetsGridView.column(columns[11],width=200,stretch=True,anchor='center')
    ...
    def __searchBudgets(self):
        ...
        items = Budget.findAllBudgets(value=self.searchEntry.get(), filter_status = self.filter_status)
